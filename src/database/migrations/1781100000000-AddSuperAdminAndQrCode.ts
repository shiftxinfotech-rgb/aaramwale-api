...
export class AddSuperAdminAndQrCode1781100000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "passes" ADD COLUMN IF NOT EXISTS "qrCode" character varying`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    // Remove qrCode column
    await queryRunner.query(`ALTER TABLE "passes" DROP COLUMN IF EXISTS "qrCode"`);
