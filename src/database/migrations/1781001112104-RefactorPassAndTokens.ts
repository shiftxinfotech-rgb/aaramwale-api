...
export class RefactorPassAndTokens1781001112104 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "assets" RENAME COLUMN "rentPerUse" TO "unitPrice"`,
    );
    await queryRunner.query(
      `ALTER TABLE "pass_items" RENAME COLUMN "quantity" TO "totalQuantity"`,
    );
    await queryRunner.query(
      `ALTER TABLE "pass_items" RENAME COLUMN "billableQuantity" TO "paidQuantity"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "tokens" ADD COLUMN "passId" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "tokens" ADD COLUMN "passItemId" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "tokens" ADD COLUMN "assetId" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "tokens" ADD COLUMN "customerId" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "tokens" ADD COLUMN "redeemedQuantity" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "tokens" ADD COLUMN "redeemedByUserId" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "tokens" ADD COLUMN "remarks" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "tokens" ADD COLUMN "redeemedAt" timestamp without time zone NOT NULL DEFAULT now()`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tokens" ADD COLUMN "chairId" integer`,
    );
    await queryRunner.query(`ALTER TABLE "tokens" ADD COLUMN "userId" integer`);

    // 4. Rename columns back in assets and pass_items
    await queryRunner.query(
      `ALTER TABLE "assets" RENAME COLUMN "unitPrice" TO "rentPerUse"`,
    );
    await queryRunner.query(
      `ALTER TABLE "pass_items" RENAME COLUMN "totalQuantity" TO "quantity"`,
    );
    await queryRunner.query(
      `ALTER TABLE "pass_items" RENAME COLUMN "paidQuantity" TO "billableQuantity"`,
    );
  }
}
