...
export class PaginationDto {
  ...
  @ApiPropertyOptional({ example: 10, description: 'Number of items per page (max 100)' })
  @IsNumber()
  @Min(1)
  @Max(100)
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: 'search_term', description: 'Search term for queries' })
  @IsString()
  @IsOptional()
  search?: string;
