...
import { IsNotEmpty, IsNumber, IsOptional, IsString, IsArray, ValidateNested, Min, IsIn } from 'class-validator';
...
export class CreatePassDto {
  ...
  @ApiPropertyOptional({ example: 10, description: 'Discount value (percentage rate or fixed amount)' })
  @IsNumber()
  @Min(0)
  @IsOptional()
