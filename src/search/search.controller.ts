...
export class SearchController {
  ...
  @ApiOperation({ summary: 'Global search across customers, passes, assets, and walk-in sessions' })
  @ApiQuery({ name: 'q', required: true, description: 'Search term (name, mobile, pass number, asset name)' })
